        ...
        <div class="col-3">
            <div class="card overflow-hidden">
                ...
                <div class="card-footer text-center py-2">
                    <a class="btn btn-link btn-sm" href="#">Мой профиль </a>
                </div>
            </div>
        </div>
        <div class="col-6">
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                Мысль успешно добавлена
            ...
            <div class="row">
                ...
                <div class="">
                    <button class="btn btn-dark"> Поделиться </button>
                </div>
            </div>
            <hr>
            <div class="mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div>
                                <button class="btn btn-primary btn-sm"> Добавить комментраий </button>
                            </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid mt-3">
                        <a class="btn btn-sm btn-primary-soft" href="#!">Показать больше</a>
                    </div>
                </div>
            </div>
        </div>
